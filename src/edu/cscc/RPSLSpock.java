...
public class RPSLSpock {
    ...
    /**
     * determine if a String input is valid for our game
     * @param pick a String that is input and should be rock, paper, scissors, lizard, or spock
     * @return true if the input received is a valid pick, false if not
     */
    ...
    /**
     * generate a psuedorandom pick for the computer
    ...
    /**
     * determine if the computer wins or not
     * @param c_pick the computer's pick
     * @param h_pick the human's pick
     * @return true if the computer wins, false if not
     */
